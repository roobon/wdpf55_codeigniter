            ...
            <li class="nav-item">
                ...
                <div id="product" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('/editor/products') ?>">All Products</a>
                        <a class="collapse-item" href="/products/create">Add new</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="category" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/category/create">Add new</a>
                    </div>
                </div>
            </li>
